        ...
        if($dbc){
            ...
            <div class="row">
                ...
                <div class="col-md-5" style="text-align:center">
                    ...
                    <div>
                         <form method="post" action="/pages/users/add.php">
                         <label style="margin-top: 10px;"><b>Quantity</b></label><br>
                          <input type="number" name="quantity" width="30%" min="1" required>
                          <input type="hidden" name="product_id" value="<?php  echo $row['id']?>"><br><br>
                          <input type="submit" name="submit" style="background-color: #383838;color:white" value="Add to Cart" class="cart btn">
                         </form>
                    </div>

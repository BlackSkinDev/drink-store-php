...
<div class="container">
    ...
    if(isset($_GET['id'])){
        ...
        <span><b>Firstname</b> : <?=$order_user_name?></span>
    ...
    <?php
        ...
        <?php
            if($order_status == 0){
                echo '  <a style="background-color:#d33b33;color:white" onclick = "dispatch('. $id.')" class="btn">Mark as delivered</a>
                ';
            }
            else{
                echo ' <a style="color:white" class="btn btn-success">Delivered</a>
                ';
            }
        ?>
        <a  href="/pages/admins/orders.php" style="background-color:#383838;color:white" class="btn">Back</a>
